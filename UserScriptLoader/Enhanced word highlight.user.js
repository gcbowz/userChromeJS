...
// #### Config I #### --------------------------{{
	...
	// keybinds
	var KEY_NEXT = 'n';		// "n"			下一个聚焦
	var KEY_PREV = 'N';		// "Shift-n"	上一个聚焦
	var KEY_SEARCH = 'M-/';	// "Alt-/"		添加关键字
	var KEY_OFF = 'M-,';	// "Alt-,"		暂停突出
	var KEY_CLOSE = 'C-M-/';	// "Ctrl-Alt-/"		禁用突出
	var KEY_EDIT = 'M-.';	// "Alt-."		编辑突出
	var KEY_REFRESH = 'r';	// "r"			刷新聚焦
